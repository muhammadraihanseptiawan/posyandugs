              ...
              @if(session('success'))
                ...
                <div class="card">
                    <div class="card-header">
                      ...
                      <a href="{{ route('export-excel-ibuhamil') }}" class="btn btn-primary ms-1">download excel file</a>
                      <a href="{{ route('export-pdf-ibuhamil') }}" class="btn btn-primary ms-1">download pdf file</a>
