            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <form method="post">
                                ...
                                <div class="form-group">
                                    <label class="font-extrabold " style="font-weight: bold; font-size:20px;"> Anak ke berapa?* </label>
                                    <input type="number" class="form-control" placeholder="anak ke" name="anakke">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="font-extrabold " style="font-weight: bold; font-size:20px;"> Jenis Kelamin* </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <p>jika belum memiliki nik isi dengan "-"</p>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="font-extrabold " style="font-weight: bold; font-size:20px;">BB Lahir (kg)*</label>
                                    <input type="number" class="form-control" placeholder="berat badan" name="bblahir">
                                </div>
                                <div class="form-group">
                                    <label class="font-extrabold " style="font-weight: bold; font-size:20px;">TB Lahir (kg)*</label>
                                    <input type="number" class="form-control" placeholder="tinggi badan" name="tblahir">
                                </div>
                                <div class="form-group">
                                    <label class="font-extrabold " style="font-weight: bold; font-size:20px;">lingkar kepala (cm)*</label>
                                    <input type="number" class="form-control" placeholder="lingkar kepala" name="lingkar_kepala_lahir">
                                </div>
                                ...
                                <div class="form-group" style="font-weight: bold; font-size:20px;">
                                    <label class="d-block" style="font-weight: bold; font-size:20px;">IMD*</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="IMD*" id="yaRadio1" value="ya">
                                        <label class="form-check-label" for="yaRadio1">
                                            Ya
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="IMD*" id="tidakRadio1" value="tidak">
                ...
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                <label class="font-extrabold " style="font-weight: bold; font-size:20px;"> Nama Orang Tua* </label>
                                <input type="text" class="form-control" name="nama_orang_tua">
                            </div>
                            <div class="form-group">
                                <label class="font-extrabold " style="font-weight: bold; font-size:20px;"> NIK Orang Tua* </label>
                                <input type="text" class="form-control" name="nik_orang_tua">
                            </div>
                            <div class="form-group">
                                <label class="font-extrabold " style="font-weight: bold; font-size:20px;"> No Hp Orang Tua* </label>
                                <input type="text" class="form-control" name="nohp_orang_tua">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="font-extrabold " style="font-weight: bold; font-size:20px;">PUSKESMA PEMBINA*</label>
