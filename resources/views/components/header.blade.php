...
<form class="form-inline mr-auto">
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                ...
                <div class="d-sm-none d-lg-inline-block">Hi, {{$user->pengelola}}</div>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
                <a href="{{ route('admin.changepassword') }}" class="dropdown-item has-icon">
                    <i class="fas fa-cog"></i> ganti password
                </a>
                <a href="{{ route('admin.changeusername') }}" class="dropdown-item has-icon">
                    <i class="fas fa-cog"></i> ganti username
                </a>
